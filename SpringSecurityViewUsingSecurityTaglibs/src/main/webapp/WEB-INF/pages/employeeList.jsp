...
<c:set var="updateMsg" value="success" scope="page" ></c:set>
<c:set var="saveMsg" value="success" scope="page" ></c:set>
<%
${updateMsg}
%>
...
<div class="container myrow-container">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">
                <div align="left"><b>Employees List</b> </div>
 				<div align="center"><b>Dear <strong>${user}</strong>, Welcome to Home Page.</b> 
 				<a style="padding-left: 200px;" href="<c:url value="/logout" />">Logout</a>
 				</div>
                <div align="right"><a href="createEmployee">Add New Employee</a></div>
            </h3>
        </div>
        <div class="login-form">
				<c:if test="${editMgs==updateMsg}" >
					<div class="alert alert-success">
						<p>Data Updated successfully.</p>
					</div>
				</c:if>
				<c:if test="${saveMgs==updateMsg}">
					<div class="alert alert-success">
   ...
   <!--  <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>    
    ...
    <script src="<c:url value="/static/js/jquery-2.2.0.min.js"/>"></script>
