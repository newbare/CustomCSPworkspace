                ...
                <form:form id="employeeRegisterForm" cssClass="form-horizontal" modelAttribute="employee" method="post" action="saveEmployee">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-4">
                            ...
                            <form:input cssClass="form-control" path="name"  value="${employeeObject.name}" placeholder="Enter Name"/>
                        </div>
                    </div>
                     <div class="form-group">
                        <div class="control-label col-xs-3"> <form:label path="email" >Email</form:label> </div>
                        <div class="col-xs-4">
                            <form:input cssClass="form-control" path="email" value="${employeeObject.email}" placeholder="Enter Email"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-4">
                            <form:input cssClass="form-control" path="age" value="${employeeObject.age}" placeholder="Enter Age"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                     <fmt:formatNumber var="fsalary"  type="number" pattern="##,###.00" value="${employeeObject.salary}" maxFractionDigits="2"/>
                        ...
                        <div class="col-xs-4">
                            <form:input cssClass="form-control" path="salary" value="${fsalary}" placeholder="Enter Salary"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                            <c:url var="getAllUrl" value="/getAllEmployees" />
                            <a href="getAllEmployees">
    						 	<input type="button" id="back" style="width: 70px;" class="btn btn-warning" value="Back" />
							</a>
